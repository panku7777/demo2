...
function Addbook() {
  ...
  const [freeview1Url, setFreeview1Url] = useState('');
  const [freeview2Url, setFreeview2Url] = useState('');
  ...
  return (
    <div className="form-container">
      ...
      <div className="column">
        ...
        <div>
          <label htmlFor="freeview1Url">Freeview 1 URL:</label>
          <input
            type="text"
            className="input-field"
            placeholder="Freeview 1 URL"
            value={freeview1Url}
            onChange={(e) => setFreeview1Url(e.target.value)}
          />
        </div>
        <div>
          <label htmlFor="freeview2Url">Freeview 2 URL:</label>
          <input
            type="text"
            className="input-field"
            placeholder="Freeview 2 URL"
            value={freeview2Url}
            onChange={(e) => setFreeview2Url(e.target.value)}
          />
        </div>
